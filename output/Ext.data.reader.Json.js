Ext.data.JsonP.Ext_data_reader_Json({
    ...
    "inheritable": false,
    "static": false,
    "superclasses": ["Ext.Base", "Ext.data.reader.Reader", "Ext.data.reader.Json"],
    "singleton": false,
    ...
    "subclasses": ["Ext.data.reader.Array"],
    "uses": [],
    "protected": false,
    "mixins": [],
    "members": {
        "property": [{
            ...
            "deprecated": {
                "doc": null,
                "tagname": "deprecated",
                "text": "<p>will be removed in Ext JS 5.0. This is just a copy of this.rawData - use that instead</p>\n",
                "version": null
            },
            "static": false,
    ...
    "alternateClassNames": ["Ext.data.JsonReader"],
    "id": "class-Ext.data.reader.Json",
    "mixedInto": [],
    "xtypes": {
        "reader": ["json"]
    },
